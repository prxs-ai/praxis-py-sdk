...
class News(_message.Message):
    ...
    content: str
    meta: NewsMeta
    def __init__(self, event_meta: _Optional[_Union[_meta_pb2.EventMeta, _Mapping]] = ..., source: _Optional[_Union[Source, str]] = ..., content: _Optional[str] = ..., meta: _Optional[_Union[NewsMeta, _Mapping]] = ...) -> None: ...
