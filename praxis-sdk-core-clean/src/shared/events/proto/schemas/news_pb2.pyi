...
class News(_message.Message):
    __slots__ = ("event_meta", "source", "content", "meta")
    ...
    source: Source
    content: _containers.MessageMap[str, _any_pb2.Any]
    meta: NewsMeta
    def __init__(self, event_meta: _Optional[_Union[_meta_pb2.EventMeta, _Mapping]] = ..., source: _Optional[_Union[Source, str]] = ..., content: _Optional[_Mapping[str, _any_pb2.Any]] = ..., meta: _Optional[_Union[NewsMeta, _Mapping]] = ...) -> None: ...
