...
@pytest.mark.a2a
@pytest.mark.asyncio
async def test_a2a_message_structure(wait_for_services, orchestrator_client, test_helper):
        ...
        "params": {
            "message": {
                ...
                "parts": [
                    {
                        "kind": "text",
                        "text": "Create a test file with A2A protocol"
                    }
                ],
...
@pytest.mark.a2a
@pytest.mark.asyncio
async def test_a2a_tool_result_format(wait_for_services, orchestrator_client, shared_dir):
...
@pytest.mark.a2a
@pytest.mark.asyncio
async def test_a2a_protocol_headers_and_metadata(wait_for_services, orchestrator_client):
