...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_dsl_to_a2a_translation(
    ...
    if "OPENAI_API_KEY" in os.environ:
        ...
        response = await test_helper.send_a2a_message(
            orchestrator_client, natural_command
        )
...
@pytest.mark.slow
@pytest.mark.asyncio
async def test_inter_agent_task_delegation(
    ...
    try:
        ...
        pytest.skip(
            "Task delegation test timed out - may indicate P2P connectivity issues"
        )
