...
def merge_files(file_paths: List[str], output_path: str = None, separator: str = "\n") -> dict:
    try:
        if not file_paths:
            return {
                "success": False,
        ...
        if output_path:
            ...
            result["content_preview"] = final_content[:500] + "..." if len(final_content) > 500 else final_content
