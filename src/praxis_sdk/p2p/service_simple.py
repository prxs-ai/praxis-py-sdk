...
class P2PService:
    ...
    async def start(self):
        ...
        await self.event_bus.emit(EventType.PEER_DISCOVERED, {
    ...
    async def connect_to_peer(self, peer_id: str, multiaddr: str) -> bool:
        ...
        if peer_id not in self.connected_peers:
            ...
            await self.event_bus.emit(EventType.PEER_CONNECTED, {
                "peer_id": peer_id,
                "multiaddr": multiaddr
            })
            return True
    ...
    async def disconnect_from_peer(self, peer_id: str):
        ...
        if peer_id in self.connected_peers:
            ...
            await self.event_bus.emit(EventType.PEER_DISCONNECTED, {
                "peer_id": peer_id
            })
    ...
    async def send_message(self, peer_id: str, protocol: str, data: bytes) -> bool:
        ...
        await self.event_bus.emit(EventType.MESSAGE_RECEIVED, {
            "peer_id": peer_id,
            "protocol": protocol,
            "data": data
        })
