...
from praxis_sdk.a2a.models import Message, Task, TaskState, create_message
...
class WorkflowState:
    ...
    def create_execution(
        self, workflow_id: str, execution_id: str, payload: WorkflowExecutionPayload
    ) -> None:
    ...
    def cancel_execution(self, workflow_id: str) -> bool:
        ...
        if workflow_id in self.executions:
            ...
            self.executions[workflow_id]["end_time"] = (
    ...
    def complete_execution(self, workflow_id: str, success: bool = True) -> None:
        ...
        if workflow_id in self.executions:
            ...
            logger.info(
                f"Completed workflow execution: {workflow_id} (success: {success})"
            )
...
class WorkflowHandlers:
    ...
    async def execute_workflow(
        ...
        try:
            ...
            estimated_duration = max(
                30, len(payload.nodes) * 10
            )  # 10 seconds per node, minimum 30s
    ...
    async def cancel_workflow(
        ...
        try:
            ...
            logger.info(
                f"Cancelling workflow: {workflow_id} (execution: {execution_id})"
            )
        ...
        try:
            ...
            for workflow_id, execution in workflow_state.executions.items():
                ...
                workflow_info = {
                    ...
                    "startTime": execution["start_time"],
                    "endTime": execution["end_time"],
                    "metadata": execution["payload"].metadata.dict()
    ...
    async def _execute_workflow_async(
        workflow_id: str, execution_id: str, payload: WorkflowExecutionPayload
    ):
            ...
            for i, node in enumerate(nodes):
                ...
                try:
                    ...
                    if execution:
                        ...
                        workflow_state.update_execution(
                            workflow_id, completed_nodes=completed_nodes
                        )
                    ...
                    data={
                        ...
                        "duration": (
                            ...
                            - datetime.fromisoformat(
                                workflow_state.get_execution(workflow_id)[
                                    "start_time"
                                ].replace("Z", "+00:00")
                            )
                        ).total_seconds(),
