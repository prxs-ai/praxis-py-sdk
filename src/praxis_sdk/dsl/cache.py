...
class ToolExecutionCache:
    ...
    def __init__(self, max_size: int = 1000, default_ttl_seconds: int = 300):
        ...
        logger.debug(f"Initialized ToolExecutionCache: max_size={max_size}, ttl={default_ttl_seconds}s")
    ...
    def set_by_key(self, key: str, value: Any, ttl_seconds: Optional[int] = None) -> None:
        """
...
class CacheKeyBuilder:
    ...
    @staticmethod
    def build_key(tool_name: str, args: Dict[str, Any], 
                  include_user: bool = False, user_id: Optional[str] = None) -> str:
        """
    ...
    @staticmethod
    def extract_tool_from_key(key: str) -> Optional[str]:
        """
