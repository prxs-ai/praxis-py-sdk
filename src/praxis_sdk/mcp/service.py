...
class MCPService:
    ...
    def get_tools(self, category: str | None = None) -> list[dict[str, Any]]:
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {**self.stats, "error": str(e), "service_status": "error"}
    ...
    async def execute_tool(
        ...
        try:
            ...
            return {"success": True, "result": result, "toolName": name}
